...
# Change settings
echo 5 > ${DEVICE}/pp_power_profile_mode
echo 175000000 > ${HWMON_DEVICE}/power1_cap 
echo "s 0 300 750" > ${DEVICE}/pp_od_clk_voltage 
echo "s 1 909 856" > ${DEVICE}/pp_od_clk_voltage 
echo "s 2 1134 950" > ${DEVICE}/pp_od_clk_voltage 
echo "s 3 1134 950" > ${DEVICE}/pp_od_clk_voltage 
echo "s 4 1134 950" > ${DEVICE}/pp_od_clk_voltage 
echo "s 5 1134 950" > ${DEVICE}/pp_od_clk_voltage 
echo "s 6 1134 950" > ${DEVICE}/pp_od_clk_voltage 
echo "s 7 1134 950" > ${DEVICE}/pp_od_clk_voltage 
